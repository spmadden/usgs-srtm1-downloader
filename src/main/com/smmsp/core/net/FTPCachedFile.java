...
/**
 * A cached file that comes from an FTP source.
 * 
 * @author sean
 * 
 */
public class FTPCachedFile extends Cachable {

	private static final Logger log = Logger.getLogger(FTPCachedFile.class);
	
	/**
	 * The URL for this FTP cached file
	 */
	private final String url;

	/**
	 * The filename within the cache directory for this file.
	 */
	 ...
	 * @param url
	 */
	public FTPCachedFile(final String filename, final String url) {
		this.url = url;
